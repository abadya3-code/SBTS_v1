...
export const seedPermissionGroups: PermissionGroupModel[] = [
  ...
  },
  {
    ...
    permissions: [
      { key: "management.view", label: "View management", description: "Read SLA, resource planning, daily progress, and management health reports", group: "Management & Planning" },
      { key: "management.manage", label: "Manage management", description: "Create daily reports, resource plans, and SLA rules", group: "Management & Planning" },
    ],
  },
  {
